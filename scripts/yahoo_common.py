...
20字上限。从以下4种策略中选一种：
▸ 反差提问 / ▸ 数字先行 / ▸ 身份带入 / ▸ 细节钩子
铁律：前7字必须出现人物全名或具体数字。故事感、变化、反差。
禁用：破防/慌了/沉默了/画风突变/评论区炸了/粉丝沸腾了/全网震惊/不敢认/太值了/绝了/炸裂/天花板/必看/不看你亏/建议收藏/干货/下一秒/那一刻/宝子们/姐妹们/太美了吧/震惊/太/超/极
日式汉字转简体。不用「！」，用句号或问号。

【故事体 — 标题规则】
不超过40字。人名不加【】括号。
对谈型：「A与B谈X：核心话题」/「从X到Y：共同面对的事」/「人物A：最重要的那句话」
叙事型：「一件事改变了什么」/「人物A的X年：转折或结果」/ 动词开头描述核心事件
对比型：「A和B，走向了两个结局」/「同一件事：A vs B」/「A×B：命运分岔」（仅此可用×不加——）
评介型：「X首歌里的情感密码」/「从选曲看A：想说什么」/「专辑名：用音乐讲述的故事」
通用禁止：×和——同时出现、深度/探讨/揭秘/光与影/温柔与坚韧等抽象对仗套话
